...
const PreFormOneInterviewReports = () => {
  ...
  const { data: interviewResults = {}, isLoading: resultsLoading } = useQuery({
    ...
    <div className="preform-one-results-page-container">
      <div className="excel-card preform-one-results">
        <div className="excel-card-header">
          <i className="fas fa-file-invoice"></i> PRE-FORM ONE INTERVIEW REPORTS
          ...
          {studentsLoading || resultsLoading ? (
            ...
            <>
              <div className="results-info">
                ...
                <div className="info-item"><strong>Reports Available:</strong> {Object.keys(interviewResults).length}</div>
              </div>
              ...
              <div className="students-reports-container">
                <h3 className="section-title">
                  <i className="fas fa-users"></i> Student Interview Reports - {year}
                </h3>
                      ...
                      <div key={student.id} className="student-report-card">
                        ...
                        <div className="student-actions">
                          <button
                            ...
                            title={hasReport ? `Generate PDF interview report for ${student.first_name} ${student.surname}` : 'No interview report data available'}
                          >
