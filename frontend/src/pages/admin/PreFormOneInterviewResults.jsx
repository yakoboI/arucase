...
const PreFormOneInterviewResults = () => {
  ...
  const calculateResultsMutation = useMutation({
    mutationFn: async () => {
      return await preFormOneService.calculateInterviewResults(year);
    },
    onSuccess: (response) => {
      ...
      queryClient.invalidateQueries(['preform-one-interview-results', year]);
    },
    onError: (error) => {
  ...
  const deleteResultMutation = useMutation({
    mutationFn: async (studentId) => {
      try {
        return await preFormOneService.deleteInterviewResult(studentId, year);
      } catch (error) {
    ...
    onError: (error) => {
      console.error('Delete interview result error:', error);
        ...
        <>
          ...
          <div className="report-header-section">
            ...
            <div className="test-info-bar">
              PRE-FORM ONE INTERVIEW RESULTS {year}
            </div>
          </div>
