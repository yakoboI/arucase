/**
 * Comments Year Selection Page for FORM I-IV
 */
import { Link } from 'react-router-dom';
import AdminLayout from '../../components/layout/AdminLayout';
import '../academic/SubjectsYearSelection.css';

const CommentsYearSelection = ({ formLevel, moduleName }) => {
            ...
            <div className="subjects-year-selection-grid">
              {years.map((year) => (
                ...
                >
                  ...
                  <div className="subjects-year-selection-label">Comments</div>
                </Link>
              ))}
            </div>
...
export default CommentsYearSelection;
